...
def restore(im, photoname):
    ...
    if debug & 2:
        newfilename = os.path.join(directory, "data", "before" + photoname)
    ...
    if debug & 2:
        newfilename = os.path.join(directory, "data", "restored" + photoname)
    ...
    # Save the intermediate result
    if debug & 2:
        newfilename = os.path.join(directory, "data", "second_restored" + photoname)
    ...
    # Save the intermediate result
    if debug & 2:
        newfilename = os.path.join(directory, "data", "combined_restored" + photoname)
    ...
    # Save the intermediate result.
    if debug & 2:
        newfilename = os.path.join(directory, "data", "enhanced" + photoname)
...
for photo in jpegs + tiffs:
    ...
    newfilename = os.path.join(directory, "data", photoname)
